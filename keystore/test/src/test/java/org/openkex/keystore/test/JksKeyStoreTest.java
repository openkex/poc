...
public class JksKeyStoreTest extends KeyStoreTest {
    ...
    protected KeyStore getKeystore() throws Exception {
        JksKeyStore.Type type = JksKeyStore.Type.JKS;
        String fileName = "storeTest." + type.toString().toLowerCase();
        String file = DirectoryTool.getTargetDirectory(JksKeyStoreTest.class) + fileName;
